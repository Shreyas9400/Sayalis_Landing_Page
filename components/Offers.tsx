...
import { OFFERS } from '../constants.tsx';
      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <div className="max-w-2xl">
            ...
            <p className="text-xl text-slate-600">We believe quality dental care should be accessible. Take advantage of our current promotions.</p>
          </div>
          <p className="text-sm text-slate-400 italic mb-2">*Offers subject to change and clinic confirmation</p>
        </div>
        <div className="grid md:grid-cols-3 gap-8">
          {OFFERS.map((offer) => (
            <div key={offer.id} className="group relative bg-slate-50 p-8 rounded-[40px] border border-transparent hover:border-slate-200 transition-all overflow-hidden">
