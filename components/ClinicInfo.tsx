...
import { CONTACT_INFO, CLINIC_TIMINGS } from '../constants';
      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 overflow-hidden bg-slate-50 rounded-[50px]">
          <div className="p-12 lg:p-20">
            ...
            <div className="mt-12">
              <a 
                ...
                target="_blank" 
                rel="noreferrer"
                className="inline-flex items-center space-x-3 bg-slate-800 text-white px-8 py-4 rounded-xl font-bold hover:bg-slate-700 transition-all shadow-lg shadow-slate-200"
              >
          ...
          <div className="h-[400px] lg:h-auto min-h-[400px] bg-slate-200 relative">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d241317.11609823277!2d72.74109995185966!3d19.082197839582234!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c6306644edc1%3A0x5da4ed8f8d648c69!2sMumbai%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin" 
